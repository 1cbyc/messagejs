...
CREATE TABLE "Template" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "connectorType" "ServiceType" NOT NULL,
    "body" TEXT NOT NULL,
    "variables" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "projectId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "MessageLog_externalMessageId_key" ON "MessageLog"("externalMessageId");

-- CreateIndex
CREATE INDEX "MessageLog_projectId_serviceId_idx" ON "MessageLog"("projectId", "serviceId");
